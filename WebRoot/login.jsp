...
<html>
  ...
  <body style="background-image:url(./images/background1.jpg)"> 
    ...
    <s:form action="loginAction" method="post" theme="simple">
        ...
        <br><br>
        <s:submit value="登录" style="border-radius:10px;width:95px;height:60px;background-color:#acd6ff;font-weight:bold;font-size:18"/><s:reset style="border-radius:10px;width:95px;height:60px;background-color:#acd6ff;font-weight:bold;font-size:18" value="重置"/>
    </s:form>
