...
<html>
  ...
  <br> <br> <br> <br> <br>
    ...
    <h3 style="text-align:center;border:1px "> 用户 <%=request.getAttribute("username")%> 您好! 当前余额为 ：<%=request.getAttribute("accbalance")%> 元 </h3>  
    ...
    <input type="button" style="border-radius:10px;width:100px;height:27px;font-weight:bold;font-size:18;background-color:#acd6ff;" name="back" value ="退出登录" onclick="window.location.href='logoutAction.action'"/>
    <br>
    </div>
    </div>
